...
- [-] **Session Capture** — 92% — Updated via commit: feat: auto-synthesize and open review on session start
...
- [-] **Session Continuity** — 83% — Updated via commit: feat: auto-synthesize and open review on session start
