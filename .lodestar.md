...
- [x] **lodestar review — browser-based session reader** — 100% — Self-contained HTML with inline CSS/JS. Live refresh polling added: client polls /check endpoint every 5s to detect .lodestar.md changes and highlight refresh button. HTML regenerates on each request for fresh data.
