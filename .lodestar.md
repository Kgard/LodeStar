...
- [-] **Terminal summary — distilled session briefing** — 70% — Updated via commit: feat: formatted lodestar start output — summary + build stat
- [x] **Cursor AI integration** — 100% — MCP tool registration, .cursorrules auto-write, trigger phrases fully functional
- [-] **lodestar diff — drift detection** — 60% — Updated via commit: feat: formatted lodestar start output — summary + build stat
