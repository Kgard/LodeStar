...
- [x] **lodestar review — browser-based session reader** — 100%
  ...
  - ✓ Pro placeholders
  - ✓ 3-tab layout
- [-] **Terminal summary — distilled session briefing** — 85%
  - ✓ 5-line briefing
  - ✓ SessionStart hook
...
- Implement feature capability markdown parsing in parseMarkdown() for reading back capabilities from .lodestar.md
- Complete lodestar diff command to detect drift between codebase state and last synthesis anchor point
- Add lodestar start explicit session command for Phase 1b tooling support (Windsurf/Cursor without SessionStart hook)
