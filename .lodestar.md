...
- [-] **Terminal summary — distilled session briefing** — 80% — Updated via commit: remove project summary paragraph from lodestar start — user 
- [x] **Cursor AI integration** — 100% — MCP tool registration, .cursorrules auto-write, trigger phrases fully functional
- [-] **lodestar diff — drift detection** — 65% — Updated via commit: remove project summary paragraph from lodestar start — user 
