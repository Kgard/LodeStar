...
- [-] **lodestar synthesize — two-diff session synthesis** — 87% — Updated via commit: chore: update session context
- [-] **lodestar load — structured context loader** — 75% — Updated via commit: chore: update session context
- [-] **lodestar review — browser-based session reader** — 95% — Updated via commit: chore: update session context
