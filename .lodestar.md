...
- [-] **Session Capture** — 91% — Updated via commit: feat: diffMode parameter, session-close double-commit, embed
...
- [-] **Session Continuity** — 83% — Updated via commit: feat: diffMode parameter, session-close double-commit, embed
